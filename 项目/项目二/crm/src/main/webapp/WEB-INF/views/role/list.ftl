            ...
            <div class="box">
                ...
                <div style="margin: 10px;">
                    ...
                    <form class="form-inline" id="searchForm" action="/role/list.do" method="post">
                        ...
                        <a href="/role/input.do" data-url="/role/input.do" class="btn btn-success btn_redirect">
                    ...
                    <table class="table table-striped table-hover" >
                       ...
                       <#list pageResult.list as entity>
                           <tr>
                               ...
                               <td>${entity.sn}</td>
                               <td>
                                   <a class="btn btn-info btn-xs btn_redirect" href="/role/input.do?id=${entity.id}" data-url="/role/input.do?id=${entity.id}">
