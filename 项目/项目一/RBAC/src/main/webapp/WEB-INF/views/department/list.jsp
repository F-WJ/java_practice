...
<%--                </div>--%>
                ...
                <a href="/department/input.do" class="btn btn-success">添加</a>
            </form>
            ...
            <table class="table table-striped table-hover" >
               ...
               <c:forEach items="${pageResult.listData}" var="entity" varStatus="vs">
                   <tr>
                       ...
                       <td>${entity.sn}</td>
                       <td>
                           <a class="btn btn-info btn-xs" href="/department/input.do?id=${entity.id}">
                               <span class="glyphicon glyphicon-pencil"></span>编辑
                           </a>
                           <a href="/department/delete.do?id=${entity.id}" class="btn btn-danger btn-xs" >
